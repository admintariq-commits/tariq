...
class JobMarket extends Model
{
    ...
    protected $fillable = ['title', 'description', 'required_skills', 'min_gpa', 'salary_range', 'region_id', 'employer_id'];
...
'@
$content | Out-File -FilePath app/Models/JobMarket.php -Encoding utf8