...
<div class="max-w-5xl mx-auto p-8">
    ...
    <footer class="text-sm text-gray-500 dark:text-gray-400 mt-8 text-center border-t pt-4">&copy; <?php echo e(date('Y')); ?> TARIQ System | Empowering Tanzanian Youth Through Data Intelligence | <a href="<?php echo e(route('home')); ?>" class="text-blue-600 hover:underline">Back Home</a></footer>
</div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\tariq\resources\views/about.blade.php ENDPATH**/ ?>