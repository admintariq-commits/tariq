            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    <button @click="open = !open" class="flex items-center space-x-2 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">
                        ...
                        <span class="hidden md:inline"><?php echo e(Auth::user()->name ?? 'Guest'); ?></span>
                    ...
                    <div x-show="open" @click.away="open = false" class="absolute right-0 mt-2 w-48 bg-white dark:bg-gray-800 rounded-md shadow-lg py-2 z-50">
                        <?php if(Auth::check() && Auth::user()->role && Auth::user()->role->name === 'admin'): ?>
                            <a href="<?php echo e(route('admin.profile')); ?>" class="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"><i class="fas fa-user mr-2"></i>Profile</a>
                            <a href="<?php echo e(route('admin.settings')); ?>" class="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"><i class="fas fa-cog mr-2"></i>Settings</a>
                        <?php elseif(Auth::check() && Auth::user()->role && Auth::user()->role->name === 'ministry'): ?>
                            <a href="<?php echo e(route('ministry.dashboard')); ?>" class="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"><i class="fas fa-landmark mr-2"></i>Ministry Dashboard</a>
                        <?php elseif(Auth::check() && Auth::user()->role && Auth::user()->role->name === 'graduate'): ?>
                            <a href="<?php echo e(route('graduate.profile')); ?>" class="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700"><i class="fas fa-user mr-2"></i>Profile</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('home')); ?>" class="block px-4 py-2 text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700">Home</a>
                        <?php endif; ?>
        ...
        <div class="h-full px-3 py-4 overflow-y-auto">
            <ul class="space-y-2 font-medium">
                <?php if(Auth::check() && Auth::user()->role && Auth::user()->role->name === 'admin'): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.graduates.index')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.graduates.create')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.alerts.index')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.heatmap')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <?php elseif(Auth::check() && Auth::user()->role && Auth::user()->role->name === 'ministry'): ?>
                    <!-- Ministry Menu -->
                    <li>
                        <a href="<?php echo e(route('ministry.dashboard')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="<?php echo e(route('ministry.analytics.dashboard')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="<?php echo e(route('ministry.alerts.index')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <i class="fas fa-bell w-5 h-5 text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"></i>
                ...
                <?php if(Auth::check() && Auth::user()->role && Auth::user()->role->name === 'graduate'): ?>
                    <!-- Graduate Menu -->
                    <li>
                        <a href="<?php echo e(route('graduate.profile')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="<?php echo e(route('graduate.job-matches')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                    ...
                    <li>
                        <a href="<?php echo e(route('graduate.applications')); ?>" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
...
<div class="mt-4">
                <a href="<?php echo e(route('about')); ?>" class="flex items-center p-2 text-gray-700 rounded-lg hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-700">
    ...
    <script src="<?php echo e(asset('js/tariq.js')); ?>" defer></script>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\tariq\resources\views/layouts/app.blade.php ENDPATH**/ ?>