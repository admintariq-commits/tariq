...
<div class="container mx-auto px-4 py-6">
    <div class="flex items-center mb-6">
        ...
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white ml-4">Add New University</h1>
    </div>
        ...
        <form action="{{ route('admin.universities.store') }}" method="POST">
            ...
            <div class="mb-6">
                ...
                <input class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg dark:bg-gray-700 dark:text-white" 
                       type="number" name="ranking" id="ranking" value="{{ old('ranking') }}" placeholder="e.g. 1">
            </div>

            <div class="flex gap-4">
                <button class="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded flex-1" type="submit">
                    <i class="fas fa-check mr-2"></i>Add University
                </button>
